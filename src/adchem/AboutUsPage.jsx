        ...
        <Para
          ...
          description={
            <p>
              ...
              De and is located in Kolkata, West Bengal. Now under the able
              guidance and proficient management skills of our honorable CEO,
              Mr. Samir De, we are scaling new heights of success in all
              business endeavors. He has a vast experience of approximately 35
            ...
            <div className="col-lg-6 order-2 order-lg-1">
              <div className="section-title text-left mb--50">
                ...
                <p className="description">
                  ...
                  infrastructural base whose overall production capacity is 10
                  tons per day. Consequently, our infrastructural unit plays a
